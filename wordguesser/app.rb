...
class WordGuesserApp < Sinatra::Base
  ...
  post '/guess' do
    ...
    if letter.nil? || letter.length != 1 || letter.empty? || letter !~ /[a-z]/
      flash[:message] = "Invalid guess."
    elsif @game.guesses.include?(letter) || @game.wrong_guesses.include?(letter.downcase)
  ...
  get '/lose' do
    ### YOUR CODE HERE ###
    @game = session[:game]
    redirect '/show' unless @game.lost?
